def get_parse_resume_prompt(resume_txt):
    return f"""Please provide me the following in JSON format:
...
- "projects" should be organized similarly to "experience" where it should be divided title, duration, and summary.Summary should contain any information that has been provided under any project.keep it as it is without changing anything
...
def get_job_details_prompt(job_details_txt):
    return f""" Please provide me the following in JSON format:
