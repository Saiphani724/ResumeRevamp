...
resume_json = {
    ...
    "projects": [
        ...
        {
            "name": "Quiz App",
            "technologies": "MERN Stack, ReactJs, Javascript, HTML, NodeJs, MongoDB",
        ...
        {
            "name": "Bug Fixing Assistance Portal",
            "technologies": "ReactJs, HTML, Java backend, Http Servlet, Apache Tomcat, XML",
        ...
        {
            "name": "PASTA Inference Classification",
            "technologies": "NLP, Python, TensorFlow, Language Modeling, RoBERTa, T5",
        ...
        {
            "name": "Shadow Removal using Diffusion",
            "technologies": "Computer Vision, Python, Pytorch, Transformers, Diffusion",
    ...
    "extra_curriculars": [
        {
            "summary": "Senior Member of Code@Amrita",
        ...
        {
            "summary": "Event Lead and Manager @ Anokha, Amrita’s techfest",
    ...
    "others": {
        "Summary": "Developing an LLM (like GPT) based tool that builds a management portal for a company using AI; it creates workflows, custom databases, and management views following specific business rules, all from requirements given in plain English.",
